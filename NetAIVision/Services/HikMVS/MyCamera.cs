...
namespace NetAIVision.Services.HikMVS
{
    /// <summary>
    /// MyCamera
    /// </summary>
    public class MyCamera
    {
        ...
        #endregion ch:相机的控制和取流接口 | en:Camera control and streaming
        ...
        #endregion ch:相机属性万能配置接口&读写寄存器接口 | en: Camera attribute nodes set and obtained universal interface
        ...
        #endregion ch: 设备升级 | en: Device upgrade interface
        ...
        #endregion ch: 注册异常回调和事件接口 | en: Enrol abnormal callbacks and event interface
        ...
        #endregion ch: 仅GigE设备支持的接口 | en: Only support GigE device interface
        ...
        #endregion ch: 仅CameraLink 设备支持的接口 | en: Only support camlink device interface
        ...
        #endregion ch: 仅U3V设备支持的接口 | en: Only support U3V device interface
        ...
        #endregion ch: GenTL相关接口 | en: GenTL related interface
        ...
        #endregion ch: 图像保存、格式转换等相关接口 | en: Related image save and format convert interface
        ...
        #endregion ch: 内部使用的公共功能接口 | en: Inner Interface
        ...
        #endregion ch: 弃用的接口 | en: Abandoned interface
        ...
        #endregion ch采集卡类型 |en Interface type
        ...
        #endregion 来自ISP算法库的错误码

        #endregion ch: 参数定义 | en: Paramera Define
        ...
        #endregion 设备升级 和 寄存器读写 和异常、事件回调
        ...
        #endregion GenTL相关接口，其它接口可以复用（部分接口不支持）
        ...
        #endregion ch: 从C/C++接口库导出的函数 | en: C/C++ Load Function
    }
}